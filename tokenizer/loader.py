...
class DataReader:
    ...
    def __init__(self, data_block_size: Optional[int] = 2**28):
    ...
    def load_csv(self, path: Union[str, os.PathLike[str]], is_header:bool =True)-> Bag:
        header = "infer"
    ...
    def load_json(self, path: Union[str, os.PathLike[str]])-> Bag:
        temp = dask.dataframe.DataFrame(dd.read_json(path, self.block_size))
        return temp.to_bag()

    def load_txt(self, path: Union[str, os.PathLike[str]], is_header:bool =True)-> Bag:
        header = "infer"
